...
[![IEEE Published](https://img.shields.io/badge/IEEE-Published%20Paper-blue?logo=ieee)](https://ieee.org/)
...
This project has been **published as an IEEE research paper**, presenting the design, implementation, and experimental results of the IoT-enabled smart helmet system for coal mining safety.

> **Published In:** IEEE Conference / Journal  
> 📎 *Refer to the paper for detailed methodology, sensor calibration data, and system evaluation metrics.*
